  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/20 via-purple-50/20 to-indigo-50/20 p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600/90 to-indigo-600/90 p-8 shadow-2xl">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">SkillMatrix</h1>
          <h2 className="text-xl text-white/90 mb-6">Your personalized career dashboard</h2>
          ...
          <div className="relative max-w-2xl">
            <input
              ...
              className="w-full p-4 pl-12 pr-16 rounded-xl border border-white/30 bg-white/20 backdrop-blur-sm text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all duration-300"
            />
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/80" size={22} />
            <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-white/90 transition-colors duration-200 flex items-center gap-2">
              <span>Search</span>
              <BarChart2 size={16} />
            </button>
          </div>
